  ...
  return (
    ...
    >
      ...
      <div className="pt-4 border-t border-white/5">
        <Link
          to={`/services#${id}`}
          className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-[#00E5FF] hover:text-white transition-colors duration-200"
        >
