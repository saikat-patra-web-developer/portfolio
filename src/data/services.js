export const coreServices = [
  {
    ...
    seoTitle: "Custom Web Application Developer | Saikat Patra",
    seoDescription: "Hire a custom web application developer for React and Laravel portals, dashboards, business tools, and scalable software solutions worldwide.",
  ...
  },
  {
    ...
    seoTitle: "Custom CRM Developer & Automation Expert | Saikat Patra",
    seoDescription: "Hire a custom CRM developer for sales pipelines, automated quotes, invoicing, customer management, and workflow automation worldwide.",
  ...
  },
  {
    ...
    seoTitle: "Business Website Developer & SEO Expert | Saikat Patra",
    seoDescription: "High-performance business website development with responsive design, technical SEO, structured data, and excellent Core Web Vitals.",
  ...
  },
  {
    ...
    seoTitle: "API Integration Developer for Hire | Saikat Patra",
    seoDescription: "Secure API, payment gateway, CRM, messaging, and webhook integrations that connect business systems and eliminate duplicate data entry.",
  ...
  },
  {
    ...
    seoTitle: "AI Integration & Automation Developer | Saikat Patra",
    seoDescription: "Hire an AI integration developer for private RAG systems, LLM applications, AI agents, and intelligent business workflow automation.",
  ...
  },
  {
    ...
    seoTitle: "Cross-Platform Mobile App Developer | Saikat Patra",
    seoDescription: "Cross-platform iOS and Android app development with React Native and Expo for customer portals, field teams, and offline workflows.",
  ...
  },
  {
    ...
    seoTitle: "SEO & GEO Expert for Global Businesses | Saikat Patra",
    seoDescription: "Technical SEO, structured data, Core Web Vitals, local search, and GEO services for stronger visibility across Google and AI search engines.",
