...
export const TestimonialCard = ({ testimonial }) => {
  ...
  return (
    <GlassCard
      ...
      className="p-5 sm:p-6 flex flex-col justify-between h-full border-[#00E5FF]/15 hover:border-[#00E5FF]/40 group transition-all duration-300 relative overflow-hidden"
    >
      <div className="space-y-3.5">
        ...
        <div className="relative">
          <Quote className="w-6 h-6 text-[#00E5FF]/15 absolute -top-1.5 -left-1 -z-0 pointer-events-none" />
        ...
        {projectSlug && (
          <div className="pt-1">
            <Link
              ...
              className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#00E5FF] hover:text-[#00E5FF]/80 transition-colors group/link"
            >
